...
Sd <- sample(Informative.d, nqtl.d) # fixed
Sf <- sample(Informative.f, nqtl.f) # fixed
...
```{r}
PWD <- paste0(getwd(),"/Test_Result04/")
...
ad_S[sample(1:length(ad_S),1000)] <- runif(-Poly.size.d,Poly.size.d,1000)
af_S[sample(1:length(af_S),1000)] <- runif(-Poly.size.f,Poly.size.f,1000)


MdS <- Md[, Sd]
MfS <- Mf[, Sf]

# A_ <- c(1,5,10,20,40,60,100,140,180,220,260,300,350,400,500,600,800,1000)
A_ <- c(20)
